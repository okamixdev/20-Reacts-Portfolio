...
export const Projects = (props) => {
    return (
        <div className="projects">
            ...
            <Project name={"Bundle Spares"} skill={'React / MongoDB / GraphQL'} img={
                'https://github.com/jeffrpar/bundle-spares/blob/main/assets/bundle-spares-screenshot.JPG?raw=true'
